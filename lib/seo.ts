...
export const siteConfig = {
  ...
  language: "pt-BR",
  locale: "pt_BR",
  title: "Carol Monteiro Nails | Nail designer em São Paulo",
  description:
    "Nail designer em São Paulo especializada em alongamento de unhas, banho de gel, esmaltação em gel, manicure, pedicure, plástica dos pés, reconstrução de unha e cursos profissionais.",
  shortDescription:
    "Alongamento, banho de gel, esmaltação em gel, manicure, pedicure e cursos profissionais em São Paulo.",
  phone: "+5511998583928",
